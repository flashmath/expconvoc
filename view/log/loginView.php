...
<div class="login-box">
    <div class="login-logo">
        <a href="index.php"><b>Logi</b>XEE</a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        ...
        <form action="index.php?log/validateLog" method="post">
        ...
        <a href="register.html" class="text-center">Enregistrer un nouveau donneur d'ordre</a>
